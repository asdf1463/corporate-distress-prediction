...
초기에는 해석 가능한 GLM Logistic Regression을 기준 모델로 사용했고, 이후 동일한 5개 재무변수와 동일한 Out-of-Time 테스트셋에 Random Forest를 추가해 **선형 기준 모델과 비선형 Bagging 모델의 예측 성능을 공정하게 비교**했습니다.
